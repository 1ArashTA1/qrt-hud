...
function TakeOutImpound(vehicle)
    ...
    if coords then
        QBCore.Functions.TriggerCallback('QBCore:Server:SpawnVehicle', function(netId)
            ...
            QBCore.Functions.TriggerCallback('qrt-garage:server:GetVehicleProperties', function(properties)
...
RegisterNetEvent('police:client:ImpoundVehicle', function(fullImpound, price, lockMinutes, reason)
    ...
    if vehicle ~= 0 and vehicle then
        ...
        if #(pos - vehpos) < 5.0 and not IsPedInAnyVehicle(ped) then
            QBCore.Functions.Progressbar('impound', Lang:t('progressbar.impound'), 5000, false, true, {
                ...
                -- ✅ ارسال تایم و دلیل به سرور
                TriggerServerEvent('police:server:Impound', plate, fullImpound, price, bodyDamage, engineDamage, totalFuel, lockMinutes, reason)
...
if Config.UseTarget then
    CreateThread(function()
        ...
        for k, v in pairs(Config.Locations['duty']) do
            exports['qrt-target']:AddCircleZone('PoliceDuty_' .. k, vector3(v.x, v.y, v.z), 0.5, {
                name = 'PoliceDuty_' .. k,
                useZ = true,
                debugPoly = false,
            }, {
        ...
        for k, v in pairs(Config.Locations['stash']) do
            exports['qrt-target']:AddCircleZone('PoliceStash_' .. k, vector3(v.x, v.y, v.z), 1.0, {
                name = 'PoliceStash_' .. k,
                useZ = true,
                debugPoly = false,
            }, {
        ...
        for k, v in pairs(Config.Locations['trash']) do
            exports['qrt-target']:AddCircleZone('PoliceTrash_' .. k, vector3(v.x, v.y, v.z), 0.5, {
                name = 'PoliceTrash_' .. k,
                useZ = true,
                debugPoly = false,
            }, {
        ...
        for k, v in pairs(Config.Locations['fingerprint']) do
            exports['qrt-target']:AddCircleZone('PoliceFingerprint_' .. k, vector3(v.x, v.y, v.z), 0.5, {
        ...
        for k, v in pairs(Config.Locations['armory']) do
            exports['qrt-target']:AddCircleZone('PoliceArmory_' .. k, vector3(v.x, v.y, v.z), 1.0, {
        ...
        -- Evidence
        for k, v in pairs(Config.Locations['evidence']) do
            exports['qrt-target']:AddCircleZone('PoliceEvidence_' .. k, vector3(v.x, v.y, v.z), 0.5, {
